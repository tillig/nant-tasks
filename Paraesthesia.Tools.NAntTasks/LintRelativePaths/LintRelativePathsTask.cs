...
namespace Paraesthesia.Tools.NAntTasks.LintRelativePaths
{
	...
	public class LintRelativePathsTask : Task
	{
		...
		public FileSet LintFileSet { get; set; }
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="LintRelativePathsTask"/> class.
		/// </summary>
		public LintRelativePathsTask()
		{
			this.LintFileSet = new FileSet();
		}
